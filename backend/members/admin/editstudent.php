...
?>
<h1 class="text-primary"><i class="fas fa-user-plus"></i>  Edit Members Informations!<small class="text-warning"> Edit Members!</small></h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     <li class="breadcrumb-item" aria-current="page"><a href="index.php">Dashboard </a></li>
     <li class="breadcrumb-item" aria-current="page"><a href="index.php?page=all-student">All Members </a></li>
...
<div class="col-sm-6">
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label for="roll">Members Roll</label>
	  	...
	  	<div class="form-group">
		    <label for="class">Members Class</label>
