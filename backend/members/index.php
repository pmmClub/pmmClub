...
<html lang="en">
  <head>
    ...
    <title>PMMC| Records</title>
  </head>
  <body>
    <div class="container"><br>
    <h1 class="logo"><a href="#"><img src="../pmmc2023/assets/img/updates/384329148_277215408557892_4795334281368800285_n.png" alt=""> </a> PMMC</a></h1>
      <a class="btn btn-primary float-right" href="admin/login.php">Login</a>
        <a class="btn btn-success float-left" href="admin/register.php">Register</a>
          <h1 class="text-center">Welcome to Officers Management System!</h1><br>
          ...
          <div class="row">
            ...
            <table class="text-center infotable">
              <tr>
                <th colspan="2">
                  <p class="text-center">Officers Information</p>
                </th>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>
                  <p><label for="roll">Code No</label></p>
                </td>
                <td>
                  <input class="form-control" type="text" pattern="[0-9]{3}" id="roll" placeholder="Code Num.." name="roll">
                </td>
              </tr>
              <tr>
        ...
        <div class="row">
          <div class="col-sm-6 offset-sm-3">
            <table class="table table-bordered">
              <tr>
                <td rowspan="5"><h3>Members Info</h3><img class="img-thumbnail" src="admin/images/<?= isset($photo)?$photo:'';?>" width="250px"></td>
                <td>Name</td>
    ...
    <footer>
    	<p>Copyright &copy; Philippine Mix MotoClub <?php echo date('Y') ?></p>
    </footer>
